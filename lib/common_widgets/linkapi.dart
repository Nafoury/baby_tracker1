...
const String linkDeleteRecord =
    "$linkServerName/diaper_change/deleteRecord.php";
...
const String linkUpdateSolids = "$linkServerName/feedSolids/update.php";
const String linkDeleteSolids = "$linkServerName/feedSolids/delete.php";
...
const String linkAddHeight = "$linkServerName/baby_height/addRecord.php";
