  ...
  void _startTimer(String side) {
    setState(() {
      ...
      if (side == 'L') {
        ...
        startTimeL = DateTime.now().subtract(elapsedTimeL);
        ...
        startTimeR = DateTime.now().subtract(elapsedTimeR);
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text("Are you sure you want to stop and add nursing data"),
            actions: [
              TextButton(
                onPressed: () {
